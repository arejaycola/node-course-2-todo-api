...
describe('GET /todos/:id', () => {
	...
	it("Should not get the specified todo created by other user", (done) => {
		request(app)
...
describe('POST /users/login', () => {
	it('Should login user and return auth token', (done) => {
		...
		.end((err, res) => {
			...
			// my attempt	
			User.findOne({'tokens.token': res.headers['x-auth']}).then((user) => {
				expect((res) => {
